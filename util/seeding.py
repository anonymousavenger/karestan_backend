...
from models.main_models import User, Company, Feedback, Review, Interview, CompanyResponse, UserType, Province, City
...
def run():
    ...
    company = Company(en_name="Chos Corp",fa_name="بهینه سازان چس اندیش",email="hi@choscorp.ir", phone="33445566", national_id="12345678901",
    city_id=1)
